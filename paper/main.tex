...
Table~\ref{tab:main_results} shows the comparison with state-of-the-art methods on EndoVis 2017 with 20\% labeled data (fold 0). GeoRisk-SPC achieves 89.84\% Dice, outperforming standard Mean Teacher (87.07\%) by 2.77\%. With the DepthGuiderV4 variant, GeoRisk-SPC+DGv4 achieves 92.15\% Dice, further improving by 2.31\%. This demonstrates that incorporating depth information through both the risk localization mechanism and the depth-guided architecture leads to significant performance gains.

% TODO: 补充 20% 全 fold 实验结果，添加标准差
% TODO: 运行 CPS, UniMatch, BCP, Min-Max Similarity, Surgivisor 基线实验
\begin{table}[htbp]
\caption{Comparison with state-of-the-art methods on EndoVis 2017 (20\% labeled data, fold 0)}
\begin{center}
\begin{tabular}{lccccc}
\toprule
Method & Dice & IoU & Prec. & Rec. & Acc. \\
\midrule
MT & 87.07 & 79.19 & 86.40 & 89.61 & 97.25 \\
UAMT & 86.56 & 78.49 & 85.32 & 90.00 & 97.03 \\
URPC & 87.45 & 79.87 & 86.35 & 90.45 & 97.38 \\
CPS \cite{chen2021cps} & -- & -- & -- & -- & -- \\
UniMatch \cite{yang2023unimatch} & -- & -- & -- & -- & -- \\
BCP \cite{bai2023bcp} & -- & -- & -- & -- & -- \\
Min-Max \cite{li2023minmax} & -- & -- & -- & -- & -- \\
Surgivisor \cite{liu2024surgivisor} & -- & -- & -- & -- & -- \\
MT\_DGv4 & 88.30 & 81.40 & 87.06 & 91.26 & 97.56 \\
Fully & 87.14 & 79.16 & 85.47 & 90.74 & 97.23 \\
\midrule
...
CPS \cite{chen2021cps} & 20\% & -- & -- & -- & -- \\
UniMatch \cite{yang2023unimatch} & 20\% & -- & -- & -- & -- \\
BCP \cite{bai2023bcp} & 20\% & -- & -- & -- & -- \\
Min-Max \cite{li2023minmax} & 20\% & -- & -- & -- & -- \\
Surgivisor \cite{liu2024surgivisor} & 20\% & -- & -- & -- & -- \\
...
GeoRisk-SPC+DGv4 & 40\% & \textbf{91.41±10.29} & 85.45±13.62 & 92.30±12.29 & 91.65±8.61 \\
GeoRisk-SPC+DGv4 & 10\% & \textbf{90.42±10.71} & 83.94±14.70 & 90.32±13.79 & 91.97±8.35 \\
% TODO: 补充 GeoRisk-SPC+DGv4 5% 全 fold 结果
% TODO: 补充 GeoRisk-SPC 20% 全 fold 结果（当前为 fold 0）
\bottomrule
\multicolumn{5}{l}{$^*$ Fold 0 result; all-fold experiments in progress.}
\end{tabular}
\end{center}
...
The DepthGuiderV4 variant consistently outperforms the plain UNet version. At 40\% labeled ratio, GeoRisk-SPC+DGv4 achieves 91.41\% Dice compared to GeoRisk-SPC's 91.15\%, with higher precision (92.30\% vs 91.50\%). The depth-guided encoder provides richer geometric features that complement the risk localization mechanism, particularly for boundary delineation.
