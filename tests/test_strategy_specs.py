...
class StrategySpecsTest(unittest.TestCase):
    ...
    def test_strategy_names_are_exposed_from_central_specs(self):
        ...
        self.assertIn("mt_depth_guider_gan_v1", names)
        self.assertIn("mt_depth_guider_gan_v2", names)
        self.assertIn("mt_depth_guider_gan_v3", names)
        self.assertNotIn("mt_depth_guider_v4_gan", names)
    ...
    def test_resolve_strategy_default_model_name_comes_from_spec(self):
        ...
        self.assertEqual(
            resolve_strategy_default_model_name("mt_depth_guider_gan_v1", "resnet"),
            "resnet_depth_guider_v4",
        )
        self.assertEqual(
            resolve_strategy_default_model_name("mt_depth_guider_gan_v2", "resnet"),
            "resnet_depth_guider_v4",
        )
        self.assertEqual(
            resolve_strategy_default_model_name("mt_depth_guider_gan_v3", "resnet"),
            "resnet_depth_guider_v4",
        )
        self.assertEqual(
